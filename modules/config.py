...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/faqek")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "https://t.me/VFF35")

# 𝐃𝐨 𝐍𝐨𝐭 𝐂𝐡𝐚𝐧𝐠𝐞 𝐓𝐡𝐢𝐬 𝐋𝐢𝐧𝐞𝐬 // 𝐈𝐠𝐧𝐨𝐫𝐞 𝐓𝐡𝐢𝐬 (𝐙𝐄𝐔𝐒 𝐎𝐏) 
COMMAND_PREFIXES = list(getenv("COMMAND_PREFIXES", "/ ! .").split())
PROFILE_CHANNEL = getenv("PROFILE_CHANNEL", "https://t.me/VFF34")
